            ...
            <div class="row gy-4 posts-list">
                ...
                <div class="col-xl-4 col-lg-6">
                    <article>
                        ...
                        <div class="d-flex align-items-center">
                            <img src="{{asset('assets/img/blog/blog-author-4.jpg')}}" alt=""
                                class="img-fluid post-author-img flex-shrink-0">
                            <div class="post-meta">
                ...
                <div class="col-xl-4 col-lg-6">
                    <article>
                        ...
                        <div class="d-flex align-items-center">
                            <img src="{{asset('assets/img/blog/blog-author-5.jpg')}}" alt=""
                                class="img-fluid post-author-img flex-shrink-0">
                            <div class="post-meta">
                ...
                <div class="col-xl-4 col-lg-6">
                    <article>
                        ...
                        <div class="d-flex align-items-center">
                            <img src="{{asset('assets/img/blog/blog-author-6.jpg')}}" alt=""
                                class="img-fluid post-author-img flex-shrink-0">
                            <div class="post-meta">
