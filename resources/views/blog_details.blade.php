            ...
            <div class="container">
                <div class="row d-flex justify-content-start text-center">
                    <div class="col-lg-2 blog-logo">
                        <img class="" src="{{ asset('assets/img/clients/client-1.png') }}" alt="">
                    </div>
                ...
                <div class="col-lg-8 box-content">
                    ...
                    <div class="box">
                        <div class="content">
                            ...
                            <p>
                                Tầng 23, Tòa nhà Viettel Complex, 285 Cách Mạng Tháng Tám, phường 12, District 10, Ho
                                Chi Minh
                            </p>
                        </div>
                    </div>
                    <div class="box">
                        <div class="content">
                            ...
                            <ul>
                                <li>Dẫn đầu thị trường</li>
                                <li>Cơ hội thử thách và phát triển bản thân</li>
